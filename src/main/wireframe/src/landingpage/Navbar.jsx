...
const navigation = [
  { name: ' Shop By Category', href: '/shopbycategory', current: false },
  { name: 'Special Offer', href: '/products', current: false },
          ...
          <Disclosure.Panel className="md:hidden">
            ...
            <div className="border-t border-gray-700 pt-4 pb-3">
              <div className="flex items-center px-5">
                ...
                <button
                  type="button"
                  className="ml-auto p-1 rounded-full bg-gray-800 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                >
                  <ShoppingCartIcon className="h-6 w-6" aria-hidden="true" />
                </button>
              </div>
